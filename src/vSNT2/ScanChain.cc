...
void PileupCorrection::ScanChain (TTree * tree, const char* outname, int MaxEvents) {
  ...
  TH1F h_all_EAs_mini("h_all_EAs_mini","All Effective Areas",20,0,10);
  ...
  TProfile p_pt_nobug_mini("p_pt_nogbug_mini","Un-bugged Corrections by p_{T}",20,0,100);
  ...
  TH1F h_all_EAs_fc("h_all_EAs_fc","All Effective Areas",20,0,10);
  ...
  TProfile p_pt_nobug_fc("p_pt_nogbug_fc","Un-bugged Corrections by p_{T}",20,0,100);
  ...
  TProfile p_npv_incl_corr_bug_fc("p_npv_incl_corr_bug_fc","Average Corrected Neut MiniIso by N_{PV} (bugged)",nPUbins,PUmin,PUmax);
  TProfile p_npv_incl_corr_nobug_fc("p_npv_incl_corr_nobug_fc","Average Corrected Neut MiniIso by N_{PV} (un-bugged)",nPUbins,PUmin,PUmax);
  ...
  for (int i = 0; i < 13; i++) {
    ...
    h_median_bug_fc.SetBinContent(i,unbugged_median_fc);
