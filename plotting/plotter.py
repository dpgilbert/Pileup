...
tl = ROOT.TLegend(0.20,0.70,0.50,0.85)
...
tl.Clear()
tl.AddEntry(h_median_bug_mini,"Central-Neutral")
tl.AddEntry(h_median_unbug_mini,"Inclusive")
tl.Draw()
...
tl.Clear()
tl.AddEntry(h_median_bug_fc,"Central-Neutral")
tl.AddEntry(h_median_unbug_fc,"Inclusive")
tl.Draw()
...
tl.Clear()
tl.AddEntry(h_all_bug_mini,"Central-Neutral")
tl.AddEntry(h_all_nobug_mini,"Inclusive")
tl.Draw()
...
tl.Clear()
tl.AddEntry(h_all_bug_fc,"Central-Neutral")
tl.AddEntry(h_all_nobug_fc,"Inclusive")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_pt_bug_mini,"Central-Neutral")
tl.AddEntry(p_pt_nobug_mini,"Inclusive")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_pt_bug_fc,"Central-Neutral")
tl.AddEntry(p_pt_nobug_fc,"Inclusive")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_incl_neut_mini,"Measured Neutrals")
tl.AddEntry(p_npv_incl_bug_mini,"Est Neut PU (CN #rho)")
tl.AddEntry(p_npv_incl_nobug_mini,"Est Neut PU (Incl #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_0p8_neut_mini,"Measured Neutrals")
tl.AddEntry(p_npv_0p8_bug_mini,"Est Neut PU (CN #rho)")
tl.AddEntry(p_npv_0p8_nobug_mini,"Est Neut PU (Incl #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_1p3_neut_mini,"Measured Neutrals")
tl.AddEntry(p_npv_1p3_bug_mini,"Est Neut PU (CN #rho)")
tl.AddEntry(p_npv_1p3_nobug_mini,"Est Neut PU (Incl #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_2p0_neut_mini,"Measured Neutrals")
tl.AddEntry(p_npv_2p0_bug_mini,"Est Neut PU (CN #rho)")
tl.AddEntry(p_npv_2p0_nobug_mini,"Est Neut PU (Incl #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_2p2_neut_mini,"Measured Neutrals")
tl.AddEntry(p_npv_2p2_bug_mini,"Est Neut PU (CN #rho)")
tl.AddEntry(p_npv_2p2_nobug_mini,"Est Neut PU (Incl #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_2p5_neut_mini,"Measured Neutrals")
tl.AddEntry(p_npv_2p5_bug_mini,"Est Neut PU (CN #rho)")
tl.AddEntry(p_npv_2p5_nobug_mini,"Est Neut PU (Incl #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_incl_neut_fc,"Measured Neutrals")
tl.AddEntry(p_npv_incl_bug_fc,"Est Neut PU (CN #rho)")
tl.AddEntry(p_npv_incl_nobug_fc,"Est Neut PU (Incl #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_0p8_neut_fc,"Measured Neutrals")
tl.AddEntry(p_npv_0p8_bug_fc,"Est Neut PU (CN #rho)")
tl.AddEntry(p_npv_0p8_nobug_fc,"Est Neut PU (Incl #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_1p3_neut_fc,"Measured Neutrals")
tl.AddEntry(p_npv_1p3_bug_fc,"Est Neut PU (CN #rho)")
tl.AddEntry(p_npv_1p3_nobug_fc,"Est Neut PU (Incl #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_2p0_neut_fc,"Measured Neutrals")
tl.AddEntry(p_npv_2p0_bug_fc,"Est Neut PU (CN #rho)")
tl.AddEntry(p_npv_2p0_nobug_fc,"Est Neut PU (Incl #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_2p2_neut_fc,"Measured Neutrals")
tl.AddEntry(p_npv_2p2_bug_fc,"Est Neut PU (CN #rho)")
tl.AddEntry(p_npv_2p2_nobug_fc,"Est Neut PU (Incl #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_2p5_neut_fc,"Measured Neutrals")
tl.AddEntry(p_npv_2p5_bug_fc,"Est Neut PU (CN #rho)")
tl.AddEntry(p_npv_2p5_nobug_fc,"Est Neut PU (Incl #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_incl_corr_bug_mini,"EA-Corrected MiniIso (CN #rho)")
tl.AddEntry(p_npv_incl_corr_nobug_mini,"EA-Corrected MiniIso (Inclusive #rho)")
tl.Draw()
...
tl.Clear()
tl.AddEntry(p_npv_incl_corr_bug_fc,"EA-Corrected Iso (CN #rho)")
tl.AddEntry(p_npv_incl_corr_nobug_fc,"EA-Corrected Iso (Inclusive #rho)")
tl.Draw()
