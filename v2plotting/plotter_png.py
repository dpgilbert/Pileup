...
canvas.SaveAs("PNGs/neut_low_bar.png")
h_neut_low_cap.Draw("hist")
canvas.SaveAs("PNGs/neut_low_cap.png")
h_neut_med_bar.Draw("hist")
canvas.SaveAs("PNGs/neut_med_bar.png")
h_neut_med_cap.Draw("hist")
canvas.SaveAs("PNGs/neut_med_cap.png")
h_neut_high_bar.Draw("hist")
canvas.SaveAs("PNGs/neut_high_bar.png")
h_neut_high_cap.Draw("hist")
canvas.SaveAs("PNGs/neut_high_cap.png")

h_neut_soft.Draw("hist")
canvas.SaveAs("PNGs/neut_soft.png")
h_neut_med.Draw("hist")
canvas.SaveAs("PNGs/neut_med.png")
h_neut_hard.Draw("hist")
canvas.SaveAs("PNGs/neut_hard.png")
...
canvas.SaveAs("PNGs/diffCorr_low_bar_rel.png")
h_diffCorr_low_cap_rel.Draw("hist")
canvas.SaveAs("PNGs/diffCorr_low_cap_rel.png")
h_diffCorr_med_bar_rel.Draw("hist")
canvas.SaveAs("PNGs/diffCorr_med_bar_rel.png")
h_diffCorr_med_cap_rel.Draw("hist")
canvas.SaveAs("PNGs/diffCorr_med_cap_rel.png")
h_diffCorr_high_bar_rel.Draw("hist")
canvas.SaveAs("PNGs/diffCorr_high_bar_rel.png")
h_diffCorr_high_cap_rel.Draw("hist")
canvas.SaveAs("PNGs/diffCorr_high_cap_rel.png")

h_neut_low_bar_rel.Draw("hist")
canvas.SaveAs("PNGs/neut_low_bar_rel.png")
h_neut_low_cap_rel.Draw("hist")
canvas.SaveAs("PNGs/neut_low_cap_rel.png")
h_neut_med_bar_rel.Draw("hist")
canvas.SaveAs("PNGs/neut_med_bar_rel.png")
h_neut_med_cap_rel.Draw("hist")
canvas.SaveAs("PNGs/neut_med_cap_rel.png")
h_neut_high_bar_rel.Draw("hist")
canvas.SaveAs("PNGs/neut_high_bar_rel.png")
h_neut_high_cap_rel.Draw("hist")
canvas.SaveAs("PNGs/neut_high_cap_rel.png")

h_neut_soft_rel.Draw("hist")
canvas.SaveAs("PNGs/neut_soft_rel.png")
h_neut_med_rel.Draw("hist")
canvas.SaveAs("PNGs/neut_med_rel.png")
h_neut_hard_rel.Draw("hist")
canvas.SaveAs("PNGs/neut_hard_rel.png")
...
canvas.SaveAs("PNGs/neut_low_bar_st.png")
h_neut_low_cap.Draw("hist")
canvas.SaveAs("PNGs/neut_low_cap_st.png")
h_neut_med_bar_st.Draw("hist")
canvas.SaveAs("PNGs/neut_med_bar_st.png")
h_neut_med_cap.Draw("hist")
canvas.SaveAs("PNGs/neut_med_cap_st.png")
h_neut_high_bar_st.Draw("hist")
canvas.SaveAs("PNGs/neut_high_bar_st.png")
h_neut_high_cap.Draw("hist")
canvas.SaveAs("PNGs/neut_high_cap_st.png")

h_neut_soft_st.Draw("hist")
canvas.SaveAs("PNGs/neut_soft_st.png")
h_neut_med_st.Draw("hist")
canvas.SaveAs("PNGs/neut_med_st.png")
h_neut_hard_st.Draw("hist")
canvas.SaveAs("PNGs/neut_hard_st.png")
...
canvas.SaveAs("PNGs/diffCorr_low_bar_rel_st.png")
h_diffCorr_low_cap_rel_st.Draw("hist")
canvas.SaveAs("PNGs/diffCorr_low_cap_rel_st.png")
h_diffCorr_med_bar_rel_st.Draw("hist")
canvas.SaveAs("PNGs/diffCorr_med_bar_rel_st.png")
h_diffCorr_med_cap_rel_st.Draw("hist")
canvas.SaveAs("PNGs/diffCorr_med_cap_rel_st.png")
h_diffCorr_high_bar_rel_st.Draw("hist")
canvas.SaveAs("PNGs/diffCorr_high_bar_rel_st.png")
h_diffCorr_high_cap_rel_st.Draw("hist")
canvas.SaveAs("PNGs/diffCorr_high_cap_rel_st.png")

h_neut_low_bar_rel_st.Draw("hist")
canvas.SaveAs("PNGs/neut_low_bar_rel_st.png")
h_neut_low_cap_rel_st.Draw("hist")
canvas.SaveAs("PNGs/neut_low_cap_rel_st.png")
h_neut_med_bar_rel_st.Draw("hist")
canvas.SaveAs("PNGs/neut_med_bar_rel_st.png")
h_neut_med_cap_rel_st.Draw("hist")
canvas.SaveAs("PNGs/neut_med_cap_rel_st.png")
h_neut_high_bar_rel_st.Draw("hist")
canvas.SaveAs("PNGs/neut_high_bar_rel_st.png")
h_neut_high_cap_rel_st.Draw("hist")
canvas.SaveAs("PNGs/neut_high_cap_rel_st.png")

h_neut_soft_rel_st.Draw("hist")
canvas.SaveAs("PNGs/neut_soft_rel_st.png")
h_neut_med_rel_st.Draw("hist")
canvas.SaveAs("PNGs/neut_med_rel_st.png")
h_neut_hard_rel_st.Draw("hist")
canvas.SaveAs("PNGs/neut_hard_rel_st.png")
...
p_pt_EA.Draw()
canvas.SaveAs("PNGs/p_pt_EA.png")
...
p_pt_dB.Draw()
canvas.SaveAs("PNGs/p_pt_dB.png")
p_npv_EA.SetTitle("#DeltaR=0.3 EA Corrections by N_{PV};Number of Pileup Vertices;Average Absolute EA Correction (GeV)")
p_npv_EA.SetTitleOffset(1.6,"y")
p_npv_EA.Draw()
canvas.SaveAs("PNGs/p_npv_EA.png")
p_npv_dB.SetTitle("#DeltaR=0.3 #Delta#beta Corrections ections by N_{PV};Number of Pileup Vertices;Average A#Delta#beta Correction (GeV)")
p_npv_dB.SetTitleOffset(1.6,"y")
p_npv_dB.Draw()
canvas.SaveAs("PNGs/p_npv_dB.png")
...
canvas.SaveAs("PNGs/rhos_ctr.png")
...
canvas.SaveAs("PNGs/rhos_all.png")
...
tl.Draw()
canvas.SaveAs("PNGs/p_npv_rhos.png")
...
#canvas.SaveAs("PNGs/p_npv_rhos_ctr.png")
